...
file. The format is based on [Conventional Commits][206]; this project adheres
to [Semantic Versioning][207].

### [3.1.6][208] (2022-06-30)

#### 🪄 Fixes

- Ensure non-object "headers" fetch argument is not mangled when mixing in
  default headers ([6e94142][209])

### [3.1.5][1] (2022-06-26)

#### 🪄 Fixes

- Fix MSW bypass override instructions and unit test ([405f84d][2])
...
- **package:** update dev-dependencies ([36a2c44][6])

### [3.1.2][7] (2022-03-23)

#### ⚙️ Build system

- **package:** update dependencies ([065b445][8])

### [3.1.1][9] (2022-02-18)

#### 🪄 Fixes

- Ensure compat with next\@12.1.0 ([484d702][10]) <sup>closes [#487][11]</sup>

#### 🔥 Reverted

- _"refactor: update npm scripts, linting"_ ([77ad96d][12])

## [3.1.0][13] (2022-02-11)

#### ✨ Features

- Automatically add the x-msw-bypass ([21b4b92][14])

#### ⚙️ Build system

- **deps:** bump next from 12.0.8 to 12.0.10 ([2a2f0b2][15])
- **readme:** explain MSW compat default behavior ([0ee4ce5][16])

### [3.0.3][17] (2022-02-05)

#### ⚙️ Build system

- **package:** bump node-fetch to 2.6.7 ([1e8cd85][18])

### [3.0.2][19] (2022-01-03)

#### ⚙️ Build system

- **readme:** update shields.io maintenance badge to 2022 ([84f74f5][20])

### [3.0.1][21] (2021-12-27)

#### ⚙️ Build system

- **package:** retire use of sort-package-json fork ([a925da2][22])
...
- **package:** remove debug dependency (moved into dev-deps) ([d3c60cb][24])
...
- **src:** move test-listen functionality into NTARH; remove dependency
  ([15c899a][26])
- **src:** replace isomorphic-unfetch with node-fetch ([5a1a2ee][27])

#### 🧙🏿 Refactored

- **src:** update types ([73f44b7][28])

### [2.3.4][29] (2021-11-16)

#### 🪄 Fixes

- **src:** lazy-load contents of the "cookies" field ([854704b][30])

#### ⚙️ Build system

- Re-enable treeshaking in webpack ([9302bcc][31])

### [2.3.3][32] (2021-11-10)

#### ⚙️ Build system

- Differentiate between esm and bundler distributables ([597c249][33])
...
- **src:** es module compatibility; no longer attempts to require() in mjs files
  ([32eafab][35])
- **src:** report parsed es module import failures properly ([cd98aab][36])

### [2.3.1][37] (2021-11-06)

#### ⚙️ Build system

- Re-enable ESM (for bundlers) integration tests ([91f08d4][38])
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][40]) <sup>closes [#373][41]</sup>

#### 🪄 Fixes

- **src:** ensure exceptions do not prevent Jest from exiting ([8746e5f][42])
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][43]) <sup>closes [#378][44]</sup>
...
- Add back nullish coalescing operator babel transform for older node versions
  ([5fbb6d2][46])
- **package:** backport npm script fixes ([346e8de][47])
- **src:** fix TS bundle errors on node\@12 and node\@14 ([812e6f2][48])

#### 🔥 Reverted

- _"chore(github): enable debug mode"_ ([5034aba][49])

### [2.2.1][50] (2021-08-29)

#### ⚙️ Build system

- **license:** switch to MIT license ([de9ee17][51])
...
- **src:** memoize resolver import ([74241ee][57])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][58])
- **src:** add descriptions to TypeScript types ([1c3425c][59])

### [2.1.1][60] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][61])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][62])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][64]) <sup>closes [#295][65]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][66])
- **webpack.config:** fix faulty env management ([f477260][67])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][68]) <sup>closes [#296][69]</sup>

### [2.0.2][70] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][71])
- **webpack.config.js:** more robust build process ([e5c6a99][72])

### [2.0.1][73] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][74])
...
- Add `url` and `paramsPatcher` ([ee31fa8][76])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][77])
- **package.json:** update dependencies ([7583209][78])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][79])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][80])
- Update dependencies ([20ca255][81])

### [1.2.24][82] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][83])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][84])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][85])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][87])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][88])
- **package.json:** update dependencies ([d328a86][89])
- **readme.md:** fix broken links ([6e7173f][90])
- **readme.md:** improvements ([23cb780][91])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][92])

### [1.2.23][93] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][94])

### [1.2.22][95] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][96])
...
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][99])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][100])
  <sup>closes [#126][101]</sup>

### [1.2.20][102] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][103])

### [1.2.19][104] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][105])
- **is-next-compat.ts:** never use console.log ([81533c8][106])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][107])
- **unit-index.test.ts:** 100% test coverage ([72189e8][108])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][109])
- **.github:** update workflows and templates ([54e51eb][110])
- Backport new webpack config ([b268534][111])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][112])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][113])
- **package.json:** remove shelljs, update other deps ([11e192a][114])
- **package.json:** update dependencies ([9e1705b][115])
- Rename env-expect to expect-env ([035e98b][116])
- **setup.ts:** fix several lib-pkg tools ([44d1967][117])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][118])
- **test:** update with new lib-pkg tools ([004a657][119])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][120])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][121])

### [1.2.18][122] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][123])

### [1.2.17][124] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][125])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][126])

### [1.2.16][127] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][128])

### [1.2.15][129] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][130])

### [1.2.14][131] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][132])

### [1.2.13][133] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][134])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][135])
  ([473ff50][136])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][137])
- **is-next-compat.ts:** better handling of generics ([d7bc091][138])
- Next no longer misclassified as CJS ([9ebac01][139])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][140])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][141])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][142])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][143])
- Drop support for node 10 ([71e9103][144])
- Only silence sjx if not DEBUG ([f01ce40][145])
- **package.json:** improved build-dist ([a3526f2][146])
- **package.json:** nicer destructured vals in docs ([661e62d][147])
- **package.json:** remove extraneous module ([1f2ad6a][148])
- **package.json:** update dependencies ([c64f761][149])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][150])
- **post-release-check.yml:** more resilient post-release check ([856435f][151])
- Properly mocked unit tests for externals ([b3273df][152])
- **test:** improved testing infrastructure ([fffe02e][153])
- **types:** more precise unique-filename type ([a60793c][154])

### [1.2.12][155] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][156])

### [1.2.11][157] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][158])

### [1.2.10][159] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][160])

### [1.2.9][161] (2021-01-21)
...
### [1.2.8][163] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][164])

### [1.2.7][165] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][166])
- Update babel-plugin-transform-mjs-imports ([62089c7][167])

### [1.2.6][168] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][169])

### [1.2.5][170] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][171])
- **.github:** add is-next-compat workflow ([1823c05][172])

### [1.2.4][173] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][174])

### [1.2.3][175] (2021-01-05)
...
### [1.2.2][177] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][178])

### [1.2.1][179] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][183])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][184])

### [1.1.3][185] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][186])
- **package.json:** manually bump version ([813b21a][187])

### [1.1.2][188] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][189])

### [1.1.1][190] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][191])
- **externals:** rewrite test workflow ([d604dfc][192])

## [1.1.0][193] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][194])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][195])

### [1.0.10][196] (2020-10-24)

### [1.0.9][197] (2020-10-23)

### [1.0.8][198] (2020-10-20)

### [1.0.7][199] (2020-10-19)

### [1.0.6][200] (2020-10-17)

### [1.0.5][201] (2020-10-13)

### [1.0.4][202] (2020-10-12)

### [1.0.3][203] (2020-10-12)

### [1.0.2][204] (2020-10-07)

### [1.0.1][205] (2020-10-07)
...
[11]: https://github.com/Xunnamius/next-test-api-route-handler/issues/487
[12]:
...
[41]: https://github.com/Xunnamius/next-test-api-route-handler/issues/373
[42]:
...
[44]: https://github.com/Xunnamius/next-test-api-route-handler/issues/378
[45]:
...
[65]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[66]:
...
[69]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[70]:
...
[135]: https://github.com/janhesters
[136]:
...
[206]: https://conventionalcommits.org

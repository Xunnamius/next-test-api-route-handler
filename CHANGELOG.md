...
- Ensure compat with next@12.1.0 ([ca1da40][215]) <sup>closes [#887][216]</sup>
...
- Ensure compat with next@12.1.0 ([484d702][16]) <sup>closes [#487][17]</sup>
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][46]) <sup>closes [#373][47]</sup>
...
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][49]) <sup>closes [#378][50]</sup>
...
- **src:** enable backwards compatibility all the way back to next@9
  ([c51cf02][70]) <sup>closes [#295][71]</sup>
...
- _"chore: update dependencies"_ ([f61fd8c][74]) <sup>closes [#296][75]</sup>

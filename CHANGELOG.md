...
file. The format is based on [Conventional Commits][137]; this project adheres
to [Semantic Versioning][138].
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][140]) <sup>closes [#295][141]</sup>
...
- **external-scripts:** use latest mongodb native driver ([fd53fef][2])
- **webpack.config.js:** more robust build process ([e5c6a99][3])

### [2.0.1][4] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][5])
...
- Add `url` and `paramsPatcher` ([ee31fa8][7])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][8])
- **package.json:** update dependencies ([7583209][9])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][10])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][11])
- Update dependencies ([20ca255][12])

### [1.2.24][13] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][14])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][15])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][16])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][18])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][19])
- **package.json:** update dependencies ([d328a86][20])
- **readme.md:** fix broken links ([6e7173f][21])
- **readme.md:** improvements ([23cb780][22])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][23])

### [1.2.23][24] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][25])

### [1.2.22][26] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][27])

### [1.2.21][28] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][29])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][30])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][31])
  <sup>closes [#126][32]</sup>

### [1.2.20][33] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][34])

### [1.2.19][35] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][36])
- **is-next-compat.ts:** never use console.log ([81533c8][37])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][38])
- **unit-index.test.ts:** 100% test coverage ([72189e8][39])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][40])
- **.github:** update workflows and templates ([54e51eb][41])
- Backport new webpack config ([b268534][42])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][43])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][44])
- **package.json:** remove shelljs, update other deps ([11e192a][45])
- **package.json:** update dependencies ([9e1705b][46])
- Rename env-expect to expect-env ([035e98b][47])
- **setup.ts:** fix several lib-pkg tools ([44d1967][48])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][49])
- **test:** update with new lib-pkg tools ([004a657][50])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][51])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][52])

### [1.2.18][53] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][54])

### [1.2.17][55] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][56])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][57])

### [1.2.16][58] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][59])

### [1.2.15][60] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][61])

### [1.2.14][62] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][63])

### [1.2.13][64] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][65])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][66])
  ([473ff50][67])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][68])
- **is-next-compat.ts:** better handling of generics ([d7bc091][69])
- Next no longer misclassified as CJS ([9ebac01][70])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][71])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][72])
...
- Only silence sjx if not DEBUG ([f01ce40][76])
- **package.json:** improved build-dist ([a3526f2][77])
- **package.json:** nicer destructured vals in docs ([661e62d][78])
- **package.json:** remove extraneous module ([1f2ad6a][79])
- **package.json:** update dependencies ([c64f761][80])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][81])
- **post-release-check.yml:** more resilient post-release check ([856435f][82])
- Properly mocked unit tests for externals ([b3273df][83])
- **test:** improved testing infrastructure ([fffe02e][84])
- **types:** more precise unique-filename type ([a60793c][85])

### [1.2.12][86] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][87])

### [1.2.11][88] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][89])

### [1.2.10][90] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][91])
...
- **readme.md:** ensure quick start example is functional ([87dc31f][95])

### [1.2.7][96] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][97])
- Update babel-plugin-transform-mjs-imports ([62089c7][98])

### [1.2.6][99] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][100])

### [1.2.5][101] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][102])
- **.github:** add is-next-compat workflow ([1823c05][103])

### [1.2.4][104] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][105])

### [1.2.3][106] (2021-01-05)
...
### [1.2.2][108] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][109])

### [1.2.1][110] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][114])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][115])

### [1.1.3][116] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][117])
- **package.json:** manually bump version ([813b21a][118])

### [1.1.2][119] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][120])

### [1.1.1][121] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][122])
- **externals:** rewrite test workflow ([d604dfc][123])

## [1.1.0][124] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][125])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][126])

### [1.0.10][127] (2020-10-24)

### [1.0.9][128] (2020-10-23)

### [1.0.8][129] (2020-10-20)

### [1.0.7][130] (2020-10-19)

### [1.0.6][131] (2020-10-17)

### [1.0.5][132] (2020-10-13)

### [1.0.4][133] (2020-10-12)

### [1.0.3][134] (2020-10-12)

### [1.0.2][135] (2020-10-07)

### [1.0.1][136] (2020-10-07)
...
[32]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[33]:
...
[66]: https://github.com/janhesters
[67]:
...
[137]: https://conventionalcommits.org

...
file. The format is based on [Conventional Commits][151]; this project adheres
to [Semantic Versioning][152].

### [2.1.3][153] (2021-08-22)
...
- **src:** memoize resolver import ([74241ee][2])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][3])
- **src:** add descriptions to TypeScript types ([1c3425c][4])

### [2.1.1][5] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][6])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][7])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][9]) <sup>closes [#295][10]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][11])
- **webpack.config:** fix faulty env management ([f477260][12])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][13]) <sup>closes [#296][14]</sup>

### [2.0.2][15] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][16])
- **webpack.config.js:** more robust build process ([e5c6a99][17])

### [2.0.1][18] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][19])
...
- Add `url` and `paramsPatcher` ([ee31fa8][21])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][22])
- **package.json:** update dependencies ([7583209][23])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][24])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][25])
- Update dependencies ([20ca255][26])

### [1.2.24][27] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][28])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][29])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][30])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][32])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][33])
- **package.json:** update dependencies ([d328a86][34])
- **readme.md:** fix broken links ([6e7173f][35])
- **readme.md:** improvements ([23cb780][36])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][37])

### [1.2.23][38] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][39])

### [1.2.22][40] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][41])

### [1.2.21][42] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][43])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][44])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][45])
  <sup>closes [#126][46]</sup>

### [1.2.20][47] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][48])

### [1.2.19][49] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][50])
- **is-next-compat.ts:** never use console.log ([81533c8][51])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][52])
- **unit-index.test.ts:** 100% test coverage ([72189e8][53])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][54])
- **.github:** update workflows and templates ([54e51eb][55])
- Backport new webpack config ([b268534][56])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][57])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][58])
- **package.json:** remove shelljs, update other deps ([11e192a][59])
- **package.json:** update dependencies ([9e1705b][60])
- Rename env-expect to expect-env ([035e98b][61])
- **setup.ts:** fix several lib-pkg tools ([44d1967][62])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][63])
- **test:** update with new lib-pkg tools ([004a657][64])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][65])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][66])

### [1.2.18][67] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][68])

### [1.2.17][69] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][70])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][71])

### [1.2.16][72] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][73])

### [1.2.15][74] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][75])

### [1.2.14][76] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][77])

### [1.2.13][78] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][79])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][80])
  ([473ff50][81])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][82])
- **is-next-compat.ts:** better handling of generics ([d7bc091][83])
- Next no longer misclassified as CJS ([9ebac01][84])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][85])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][86])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][87])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][88])
- Drop support for node 10 ([71e9103][89])
- Only silence sjx if not DEBUG ([f01ce40][90])
- **package.json:** improved build-dist ([a3526f2][91])
- **package.json:** nicer destructured vals in docs ([661e62d][92])
- **package.json:** remove extraneous module ([1f2ad6a][93])
- **package.json:** update dependencies ([c64f761][94])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][95])
- **post-release-check.yml:** more resilient post-release check ([856435f][96])
- Properly mocked unit tests for externals ([b3273df][97])
- **test:** improved testing infrastructure ([fffe02e][98])
- **types:** more precise unique-filename type ([a60793c][99])

### [1.2.12][100] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][101])

### [1.2.11][102] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][103])

### [1.2.10][104] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][105])

### [1.2.9][106] (2021-01-21)
...
### [1.2.8][108] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][109])

### [1.2.7][110] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][111])
- Update babel-plugin-transform-mjs-imports ([62089c7][112])

### [1.2.6][113] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][114])

### [1.2.5][115] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][116])
- **.github:** add is-next-compat workflow ([1823c05][117])

### [1.2.4][118] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][119])

### [1.2.3][120] (2021-01-05)
...
### [1.2.2][122] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][123])

### [1.2.1][124] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][128])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][129])

### [1.1.3][130] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][131])
- **package.json:** manually bump version ([813b21a][132])

### [1.1.2][133] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][134])

### [1.1.1][135] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][136])
- **externals:** rewrite test workflow ([d604dfc][137])

## [1.1.0][138] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][139])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][140])

### [1.0.10][141] (2020-10-24)

### [1.0.9][142] (2020-10-23)

### [1.0.8][143] (2020-10-20)

### [1.0.7][144] (2020-10-19)

### [1.0.6][145] (2020-10-17)

### [1.0.5][146] (2020-10-13)

### [1.0.4][147] (2020-10-12)

### [1.0.3][148] (2020-10-12)

### [1.0.2][149] (2020-10-07)

### [1.0.1][150] (2020-10-07)
...
[10]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[11]:
...
[14]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[15]:
...
[46]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[47]:
...
[80]: https://github.com/janhesters
[81]:
...
[151]: https://conventionalcommits.org

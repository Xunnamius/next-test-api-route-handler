...
file. The format is based on [Conventional Commits][170]; this project adheres
to [Semantic Versioning][171].

### [2.3.2][172] (2021-11-07)

#### 🪄 Fixes

- **src:** es module compatibility; no longer attempts to require() in mjs files
  ([32eafab][173])
- **src:** report parsed es module import failures properly ([cd98aab][174])

### [2.3.1][1] (2021-11-06)

#### ⚙️ Build system

- Re-enable ESM (for bundlers) integration tests ([91f08d4][2])
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][4]) <sup>closes [#373][5]</sup>

#### 🪄 Fixes

- **src:** ensure exceptions do not prevent Jest from exiting ([8746e5f][6])
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][7]) <sup>closes [#378][8]</sup>
...
- Add back nullish coalescing operator babel transform for older node versions
  ([5fbb6d2][10])
- **package:** backport npm script fixes ([346e8de][11])
- **src:** fix TS bundle errors on node\@12 and node\@14 ([812e6f2][12])

#### 🔥 Reverted

- _"chore(github): enable debug mode"_ ([5034aba][13])

### [2.2.1][14] (2021-08-29)

#### ⚙️ Build system

- **license:** switch to MIT license ([de9ee17][15])
...
- **src:** memoize resolver import ([74241ee][21])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][22])
- **src:** add descriptions to TypeScript types ([1c3425c][23])

### [2.1.1][24] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][25])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][26])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][28]) <sup>closes [#295][29]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][30])
- **webpack.config:** fix faulty env management ([f477260][31])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][32]) <sup>closes [#296][33]</sup>

### [2.0.2][34] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][35])
- **webpack.config.js:** more robust build process ([e5c6a99][36])

### [2.0.1][37] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][38])
...
- Add `url` and `paramsPatcher` ([ee31fa8][40])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][41])
- **package.json:** update dependencies ([7583209][42])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][43])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][44])
- Update dependencies ([20ca255][45])

### [1.2.24][46] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][47])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][48])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][49])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][51])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][52])
- **package.json:** update dependencies ([d328a86][53])
- **readme.md:** fix broken links ([6e7173f][54])
- **readme.md:** improvements ([23cb780][55])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][56])

### [1.2.23][57] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][58])

### [1.2.22][59] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][60])

### [1.2.21][61] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][62])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][63])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][64])
  <sup>closes [#126][65]</sup>

### [1.2.20][66] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][67])

### [1.2.19][68] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][69])
- **is-next-compat.ts:** never use console.log ([81533c8][70])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][71])
- **unit-index.test.ts:** 100% test coverage ([72189e8][72])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][73])
- **.github:** update workflows and templates ([54e51eb][74])
- Backport new webpack config ([b268534][75])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][76])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][77])
- **package.json:** remove shelljs, update other deps ([11e192a][78])
- **package.json:** update dependencies ([9e1705b][79])
- Rename env-expect to expect-env ([035e98b][80])
- **setup.ts:** fix several lib-pkg tools ([44d1967][81])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][82])
- **test:** update with new lib-pkg tools ([004a657][83])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][84])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][85])

### [1.2.18][86] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][87])

### [1.2.17][88] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][89])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][90])

### [1.2.16][91] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][92])

### [1.2.15][93] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][94])

### [1.2.14][95] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][96])

### [1.2.13][97] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][98])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][99])
  ([473ff50][100])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][101])
- **is-next-compat.ts:** better handling of generics ([d7bc091][102])
- Next no longer misclassified as CJS ([9ebac01][103])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][104])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][105])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][106])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][107])
- Drop support for node 10 ([71e9103][108])
- Only silence sjx if not DEBUG ([f01ce40][109])
- **package.json:** improved build-dist ([a3526f2][110])
- **package.json:** nicer destructured vals in docs ([661e62d][111])
- **package.json:** remove extraneous module ([1f2ad6a][112])
- **package.json:** update dependencies ([c64f761][113])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][114])
- **post-release-check.yml:** more resilient post-release check ([856435f][115])
- Properly mocked unit tests for externals ([b3273df][116])
- **test:** improved testing infrastructure ([fffe02e][117])
- **types:** more precise unique-filename type ([a60793c][118])

### [1.2.12][119] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][120])

### [1.2.11][121] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][122])

### [1.2.10][123] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][124])

### [1.2.9][125] (2021-01-21)
...
### [1.2.8][127] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][128])

### [1.2.7][129] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][130])
- Update babel-plugin-transform-mjs-imports ([62089c7][131])

### [1.2.6][132] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][133])

### [1.2.5][134] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][135])
- **.github:** add is-next-compat workflow ([1823c05][136])

### [1.2.4][137] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][138])

### [1.2.3][139] (2021-01-05)
...
### [1.2.2][141] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][142])

### [1.2.1][143] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][147])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][148])

### [1.1.3][149] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][150])
- **package.json:** manually bump version ([813b21a][151])

### [1.1.2][152] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][153])

### [1.1.1][154] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][155])
- **externals:** rewrite test workflow ([d604dfc][156])

## [1.1.0][157] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][158])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][159])

### [1.0.10][160] (2020-10-24)

### [1.0.9][161] (2020-10-23)

### [1.0.8][162] (2020-10-20)

### [1.0.7][163] (2020-10-19)

### [1.0.6][164] (2020-10-17)

### [1.0.5][165] (2020-10-13)

### [1.0.4][166] (2020-10-12)

### [1.0.3][167] (2020-10-12)

### [1.0.2][168] (2020-10-07)

### [1.0.1][169] (2020-10-07)
...
[5]: https://github.com/Xunnamius/next-test-api-route-handler/issues/373
[6]:
...
[8]: https://github.com/Xunnamius/next-test-api-route-handler/issues/378
[9]:
...
[29]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[30]:
...
[33]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[34]:
...
[65]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[66]:
...
[99]: https://github.com/janhesters
[100]:
...
[170]: https://conventionalcommits.org
[171]: https://semver.org
[172]:

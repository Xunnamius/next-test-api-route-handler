...
file. The format is based on [Conventional Commits][184]; this project adheres
to [Semantic Versioning][185].

### [3.0.1][186] (2021-12-27)

#### ⚙️ Build system

- **package:** retire use of sort-package-json fork ([a925da2][187])
...
- **package:** remove debug dependency (moved into dev-deps) ([d3c60cb][2])
...
- **src:** move test-listen functionality into NTARH; remove dependency
  ([15c899a][4])
- **src:** replace isomorphic-unfetch with node-fetch ([5a1a2ee][5])

#### 🧙🏿 Refactored

- **src:** update types ([73f44b7][6])

### [2.3.4][7] (2021-11-16)

#### 🪄 Fixes

- **src:** lazy-load contents of the "cookies" field ([854704b][8])

#### ⚙️ Build system

- Re-enable treeshaking in webpack ([9302bcc][9])

### [2.3.3][10] (2021-11-10)

#### ⚙️ Build system

- Differentiate between esm and bundler distributables ([597c249][11])
...
- **src:** es module compatibility; no longer attempts to require() in mjs files
  ([32eafab][13])
- **src:** report parsed es module import failures properly ([cd98aab][14])

### [2.3.1][15] (2021-11-06)

#### ⚙️ Build system

- Re-enable ESM (for bundlers) integration tests ([91f08d4][16])
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][18]) <sup>closes [#373][19]</sup>

#### 🪄 Fixes

- **src:** ensure exceptions do not prevent Jest from exiting ([8746e5f][20])
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][21]) <sup>closes [#378][22]</sup>
...
- Add back nullish coalescing operator babel transform for older node versions
  ([5fbb6d2][24])
- **package:** backport npm script fixes ([346e8de][25])
- **src:** fix TS bundle errors on node\@12 and node\@14 ([812e6f2][26])

#### 🔥 Reverted

- _"chore(github): enable debug mode"_ ([5034aba][27])

### [2.2.1][28] (2021-08-29)

#### ⚙️ Build system

- **license:** switch to MIT license ([de9ee17][29])
...
- **src:** memoize resolver import ([74241ee][35])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][36])
- **src:** add descriptions to TypeScript types ([1c3425c][37])

### [2.1.1][38] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][39])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][40])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][42]) <sup>closes [#295][43]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][44])
- **webpack.config:** fix faulty env management ([f477260][45])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][46]) <sup>closes [#296][47]</sup>

### [2.0.2][48] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][49])
- **webpack.config.js:** more robust build process ([e5c6a99][50])

### [2.0.1][51] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][52])
...
- Add `url` and `paramsPatcher` ([ee31fa8][54])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][55])
- **package.json:** update dependencies ([7583209][56])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][57])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][58])
- Update dependencies ([20ca255][59])

### [1.2.24][60] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][61])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][62])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][63])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][65])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][66])
- **package.json:** update dependencies ([d328a86][67])
- **readme.md:** fix broken links ([6e7173f][68])
- **readme.md:** improvements ([23cb780][69])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][70])

### [1.2.23][71] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][72])

### [1.2.22][73] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][74])

### [1.2.21][75] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][76])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][77])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][78])
  <sup>closes [#126][79]</sup>

### [1.2.20][80] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][81])

### [1.2.19][82] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][83])
- **is-next-compat.ts:** never use console.log ([81533c8][84])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][85])
- **unit-index.test.ts:** 100% test coverage ([72189e8][86])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][87])
- **.github:** update workflows and templates ([54e51eb][88])
- Backport new webpack config ([b268534][89])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][90])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][91])
- **package.json:** remove shelljs, update other deps ([11e192a][92])
- **package.json:** update dependencies ([9e1705b][93])
- Rename env-expect to expect-env ([035e98b][94])
- **setup.ts:** fix several lib-pkg tools ([44d1967][95])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][96])
- **test:** update with new lib-pkg tools ([004a657][97])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][98])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][99])

### [1.2.18][100] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][101])

### [1.2.17][102] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][103])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][104])

### [1.2.16][105] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][106])

### [1.2.15][107] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][108])

### [1.2.14][109] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][110])

### [1.2.13][111] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][112])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][113])
  ([473ff50][114])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][115])
- **is-next-compat.ts:** better handling of generics ([d7bc091][116])
- Next no longer misclassified as CJS ([9ebac01][117])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][118])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][119])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][120])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][121])
- Drop support for node 10 ([71e9103][122])
- Only silence sjx if not DEBUG ([f01ce40][123])
- **package.json:** improved build-dist ([a3526f2][124])
- **package.json:** nicer destructured vals in docs ([661e62d][125])
- **package.json:** remove extraneous module ([1f2ad6a][126])
- **package.json:** update dependencies ([c64f761][127])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][128])
- **post-release-check.yml:** more resilient post-release check ([856435f][129])
- Properly mocked unit tests for externals ([b3273df][130])
- **test:** improved testing infrastructure ([fffe02e][131])
- **types:** more precise unique-filename type ([a60793c][132])

### [1.2.12][133] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][134])

### [1.2.11][135] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][136])

### [1.2.10][137] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][138])

### [1.2.9][139] (2021-01-21)
...
### [1.2.8][141] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][142])

### [1.2.7][143] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][144])
- Update babel-plugin-transform-mjs-imports ([62089c7][145])

### [1.2.6][146] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][147])

### [1.2.5][148] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][149])
- **.github:** add is-next-compat workflow ([1823c05][150])

### [1.2.4][151] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][152])

### [1.2.3][153] (2021-01-05)
...
### [1.2.2][155] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][156])

### [1.2.1][157] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][161])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][162])

### [1.1.3][163] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][164])
- **package.json:** manually bump version ([813b21a][165])

### [1.1.2][166] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][167])

### [1.1.1][168] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][169])
- **externals:** rewrite test workflow ([d604dfc][170])

## [1.1.0][171] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][172])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][173])

### [1.0.10][174] (2020-10-24)

### [1.0.9][175] (2020-10-23)

### [1.0.8][176] (2020-10-20)

### [1.0.7][177] (2020-10-19)

### [1.0.6][178] (2020-10-17)

### [1.0.5][179] (2020-10-13)

### [1.0.4][180] (2020-10-12)

### [1.0.3][181] (2020-10-12)

### [1.0.2][182] (2020-10-07)

### [1.0.1][183] (2020-10-07)
...
[19]: https://github.com/Xunnamius/next-test-api-route-handler/issues/373
[20]:
...
[22]: https://github.com/Xunnamius/next-test-api-route-handler/issues/378
[23]:
...
[43]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[44]:
...
[47]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[48]:
...
[79]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[80]:
...
[113]: https://github.com/janhesters
[114]:
...
[184]: https://conventionalcommits.org
[185]: https://semver.org
[186]:

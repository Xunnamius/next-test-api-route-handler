...
file. The format is based on [Conventional Commits][178]; this project adheres
to [Semantic Versioning][179].

## [3.0.0][180] (2021-12-17)
...
- **package:** remove debug dependency (moved into dev-deps) ([d3c60cb][181])
...
- **src:** move test-listen functionality into NTARH; remove dependency
  ([15c899a][183])
- **src:** replace isomorphic-unfetch with node-fetch ([5a1a2ee][184])

#### 🧙🏿 Refactored

- **src:** update types ([73f44b7][185])

### [2.3.4][1] (2021-11-16)

#### 🪄 Fixes

- **src:** lazy-load contents of the "cookies" field ([854704b][2])

#### ⚙️ Build system

- Re-enable treeshaking in webpack ([9302bcc][3])

### [2.3.3][4] (2021-11-10)

#### ⚙️ Build system

- Differentiate between esm and bundler distributables ([597c249][5])
...
- **src:** es module compatibility; no longer attempts to require() in mjs files
  ([32eafab][7])
- **src:** report parsed es module import failures properly ([cd98aab][8])

### [2.3.1][9] (2021-11-06)

#### ⚙️ Build system

- Re-enable ESM (for bundlers) integration tests ([91f08d4][10])
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][12]) <sup>closes [#373][13]</sup>

#### 🪄 Fixes

- **src:** ensure exceptions do not prevent Jest from exiting ([8746e5f][14])
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][15]) <sup>closes [#378][16]</sup>
...
- Add back nullish coalescing operator babel transform for older node versions
  ([5fbb6d2][18])
- **package:** backport npm script fixes ([346e8de][19])
- **src:** fix TS bundle errors on node\@12 and node\@14 ([812e6f2][20])

#### 🔥 Reverted

- _"chore(github): enable debug mode"_ ([5034aba][21])

### [2.2.1][22] (2021-08-29)

#### ⚙️ Build system

- **license:** switch to MIT license ([de9ee17][23])
...
- **src:** memoize resolver import ([74241ee][29])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][30])
- **src:** add descriptions to TypeScript types ([1c3425c][31])

### [2.1.1][32] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][33])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][34])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][36]) <sup>closes [#295][37]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][38])
- **webpack.config:** fix faulty env management ([f477260][39])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][40]) <sup>closes [#296][41]</sup>

### [2.0.2][42] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][43])
- **webpack.config.js:** more robust build process ([e5c6a99][44])

### [2.0.1][45] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][46])
...
- Add `url` and `paramsPatcher` ([ee31fa8][48])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][49])
- **package.json:** update dependencies ([7583209][50])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][51])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][52])
- Update dependencies ([20ca255][53])

### [1.2.24][54] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][55])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][56])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][57])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][59])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][60])
- **package.json:** update dependencies ([d328a86][61])
- **readme.md:** fix broken links ([6e7173f][62])
- **readme.md:** improvements ([23cb780][63])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][64])

### [1.2.23][65] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][66])

### [1.2.22][67] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][68])

### [1.2.21][69] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][70])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][71])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][72])
  <sup>closes [#126][73]</sup>

### [1.2.20][74] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][75])

### [1.2.19][76] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][77])
- **is-next-compat.ts:** never use console.log ([81533c8][78])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][79])
- **unit-index.test.ts:** 100% test coverage ([72189e8][80])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][81])
- **.github:** update workflows and templates ([54e51eb][82])
- Backport new webpack config ([b268534][83])
...
- Rename env-expect to expect-env ([035e98b][88])
- **setup.ts:** fix several lib-pkg tools ([44d1967][89])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][90])
- **test:** update with new lib-pkg tools ([004a657][91])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][92])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][93])

### [1.2.18][94] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][95])

### [1.2.17][96] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][97])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][98])

### [1.2.16][99] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][100])

### [1.2.15][101] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][102])

### [1.2.14][103] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][104])

### [1.2.13][105] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][106])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][107])
  ([473ff50][108])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][109])
- **is-next-compat.ts:** better handling of generics ([d7bc091][110])
- Next no longer misclassified as CJS ([9ebac01][111])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][112])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][113])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][114])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][115])
- Drop support for node 10 ([71e9103][116])
- Only silence sjx if not DEBUG ([f01ce40][117])
- **package.json:** improved build-dist ([a3526f2][118])
- **package.json:** nicer destructured vals in docs ([661e62d][119])
- **package.json:** remove extraneous module ([1f2ad6a][120])
- **package.json:** update dependencies ([c64f761][121])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][122])
- **post-release-check.yml:** more resilient post-release check ([856435f][123])
- Properly mocked unit tests for externals ([b3273df][124])
- **test:** improved testing infrastructure ([fffe02e][125])
- **types:** more precise unique-filename type ([a60793c][126])

### [1.2.12][127] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][128])

### [1.2.11][129] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][130])

### [1.2.10][131] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][132])

### [1.2.9][133] (2021-01-21)
...
### [1.2.8][135] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][136])

### [1.2.7][137] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][138])
- Update babel-plugin-transform-mjs-imports ([62089c7][139])

### [1.2.6][140] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][141])

### [1.2.5][142] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][143])
- **.github:** add is-next-compat workflow ([1823c05][144])

### [1.2.4][145] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][146])

### [1.2.3][147] (2021-01-05)
...
### [1.2.2][149] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][150])

### [1.2.1][151] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][155])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][156])

### [1.1.3][157] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][158])
- **package.json:** manually bump version ([813b21a][159])

### [1.1.2][160] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][161])

### [1.1.1][162] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][163])
- **externals:** rewrite test workflow ([d604dfc][164])

## [1.1.0][165] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][166])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][167])

### [1.0.10][168] (2020-10-24)

### [1.0.9][169] (2020-10-23)

### [1.0.8][170] (2020-10-20)

### [1.0.7][171] (2020-10-19)

### [1.0.6][172] (2020-10-17)

### [1.0.5][173] (2020-10-13)

### [1.0.4][174] (2020-10-12)

### [1.0.3][175] (2020-10-12)

### [1.0.2][176] (2020-10-07)

### [1.0.1][177] (2020-10-07)
...
[13]: https://github.com/Xunnamius/next-test-api-route-handler/issues/373
[14]:
...
[16]: https://github.com/Xunnamius/next-test-api-route-handler/issues/378
[17]:
...
[37]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[38]:
...
[41]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[42]:
...
[73]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[74]:
...
[107]: https://github.com/janhesters
[108]:
...
[178]: https://conventionalcommits.org
[179]: https://semver.org
[180]:

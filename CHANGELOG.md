...
file. The format is based on [Conventional Commits][157]; this project adheres
to [Semantic Versioning][158].

## [2.3.0][159] (2021-11-05)

#### ✨ Features

- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][160]) <sup>closes [#373][161]</sup>
...
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][163]) <sup>closes [#378][164]</sup>
...
- **license:** switch to MIT license ([de9ee17][2])
...
[157]: https://conventionalcommits.org
[158]: https://semver.org
[159]:

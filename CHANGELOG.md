...
file. The format is based on [Conventional Commits][168]; this project adheres
to [Semantic Versioning][169].

### [2.3.1][170] (2021-11-06)

#### ⚙️ Build system

- Re-enable ESM (for bundlers) integration tests ([91f08d4][171])
...
- Automatically parse "set-cookie" headers; available in response.cookies
  ([cd3cd95][2]) <sup>closes [#373][3]</sup>

#### 🪄 Fixes

- **src:** ensure exceptions do not prevent Jest from exiting ([8746e5f][4])
- **src:** ensure webpack does not break dynamic require on compile
  ([ae778d1][5]) <sup>closes [#378][6]</sup>
...
- Add back nullish coalescing operator babel transform for older node versions
  ([5fbb6d2][8])
- **package:** backport npm script fixes ([346e8de][9])
- **src:** fix TS bundle errors on node\@12 and node\@14 ([812e6f2][10])

#### 🔥 Reverted

- _"chore(github): enable debug mode"_ ([5034aba][11])

### [2.2.1][12] (2021-08-29)

#### ⚙️ Build system

- **license:** switch to MIT license ([de9ee17][13])
...
- **src:** memoize resolver import ([74241ee][19])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][20])
- **src:** add descriptions to TypeScript types ([1c3425c][21])

### [2.1.1][22] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][23])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][24])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][26]) <sup>closes [#295][27]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][28])
- **webpack.config:** fix faulty env management ([f477260][29])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][30]) <sup>closes [#296][31]</sup>

### [2.0.2][32] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][33])
- **webpack.config.js:** more robust build process ([e5c6a99][34])

### [2.0.1][35] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][36])
...
- Add `url` and `paramsPatcher` ([ee31fa8][38])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][39])
- **package.json:** update dependencies ([7583209][40])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][41])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][42])
- Update dependencies ([20ca255][43])

### [1.2.24][44] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][45])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][46])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][47])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][49])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][50])
- **package.json:** update dependencies ([d328a86][51])
- **readme.md:** fix broken links ([6e7173f][52])
- **readme.md:** improvements ([23cb780][53])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][54])

### [1.2.23][55] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][56])

### [1.2.22][57] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][58])

### [1.2.21][59] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][60])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][61])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][62])
  <sup>closes [#126][63]</sup>

### [1.2.20][64] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][65])

### [1.2.19][66] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][67])
- **is-next-compat.ts:** never use console.log ([81533c8][68])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][69])
- **unit-index.test.ts:** 100% test coverage ([72189e8][70])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][71])
- **.github:** update workflows and templates ([54e51eb][72])
- Backport new webpack config ([b268534][73])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][74])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][75])
- **package.json:** remove shelljs, update other deps ([11e192a][76])
- **package.json:** update dependencies ([9e1705b][77])
- Rename env-expect to expect-env ([035e98b][78])
- **setup.ts:** fix several lib-pkg tools ([44d1967][79])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][80])
- **test:** update with new lib-pkg tools ([004a657][81])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][82])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][83])

### [1.2.18][84] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][85])

### [1.2.17][86] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][87])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][88])

### [1.2.16][89] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][90])

### [1.2.15][91] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][92])

### [1.2.14][93] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][94])

### [1.2.13][95] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][96])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][97])
  ([473ff50][98])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][99])
- **is-next-compat.ts:** better handling of generics ([d7bc091][100])
- Next no longer misclassified as CJS ([9ebac01][101])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][102])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][103])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][104])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][105])
- Drop support for node 10 ([71e9103][106])
- Only silence sjx if not DEBUG ([f01ce40][107])
- **package.json:** improved build-dist ([a3526f2][108])
- **package.json:** nicer destructured vals in docs ([661e62d][109])
- **package.json:** remove extraneous module ([1f2ad6a][110])
- **package.json:** update dependencies ([c64f761][111])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][112])
- **post-release-check.yml:** more resilient post-release check ([856435f][113])
- Properly mocked unit tests for externals ([b3273df][114])
- **test:** improved testing infrastructure ([fffe02e][115])
- **types:** more precise unique-filename type ([a60793c][116])

### [1.2.12][117] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][118])

### [1.2.11][119] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][120])

### [1.2.10][121] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][122])

### [1.2.9][123] (2021-01-21)
...
### [1.2.8][125] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][126])

### [1.2.7][127] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][128])
- Update babel-plugin-transform-mjs-imports ([62089c7][129])

### [1.2.6][130] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][131])

### [1.2.5][132] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][133])
- **.github:** add is-next-compat workflow ([1823c05][134])

### [1.2.4][135] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][136])

### [1.2.3][137] (2021-01-05)
...
### [1.2.2][139] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][140])

### [1.2.1][141] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][145])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][146])

### [1.1.3][147] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][148])
- **package.json:** manually bump version ([813b21a][149])

### [1.1.2][150] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][151])

### [1.1.1][152] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][153])
- **externals:** rewrite test workflow ([d604dfc][154])

## [1.1.0][155] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][156])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][157])

### [1.0.10][158] (2020-10-24)

### [1.0.9][159] (2020-10-23)

### [1.0.8][160] (2020-10-20)

### [1.0.7][161] (2020-10-19)

### [1.0.6][162] (2020-10-17)

### [1.0.5][163] (2020-10-13)

### [1.0.4][164] (2020-10-12)

### [1.0.3][165] (2020-10-12)

### [1.0.2][166] (2020-10-07)

### [1.0.1][167] (2020-10-07)
...
[3]: https://github.com/Xunnamius/next-test-api-route-handler/issues/373
[4]:
...
[6]: https://github.com/Xunnamius/next-test-api-route-handler/issues/378
[7]:
...
[27]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[28]:
...
[31]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[32]:
...
[63]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[64]:
...
[97]: https://github.com/janhesters
[98]:
...
[168]: https://conventionalcommits.org
[169]: https://semver.org
[170]:

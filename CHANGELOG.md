...
file. The format is based on [Conventional Commits][153]; this project adheres
to [Semantic Versioning][154].

## [2.2.0][155] (2021-08-22)
...
- **src:** memoize resolver import ([74241ee][4])

#### ⚙️ Build system

- **package:** improve build-docs npm script ([33b6a34][5])
- **src:** add descriptions to TypeScript types ([1c3425c][6])

### [2.1.1][7] (2021-08-13)

#### 🪄 Fixes

- **readme:** update install instructions; fix apollo example ([fd787ca][8])

#### ⚙️ Build system

- **webpack.config:** second fix for faulty env management ([87ed12b][9])
...
- **src:** enable backwards compatibility all the way back to next\@9
  ([c51cf02][11]) <sup>closes [#295][12]</sup>

#### ⚙️ Build system

- **webpack.config:** do not ignore warnings ([2b14d84][13])
- **webpack.config:** fix faulty env management ([f477260][14])

#### 🔥 Reverted

- _"chore: update dependencies"_ ([f61fd8c][15]) <sup>closes [#296][16]</sup>

### [2.0.2][17] (2021-07-29)

#### ⚙️ Build system

- **external-scripts:** use latest mongodb native driver ([fd53fef][18])
- **webpack.config.js:** more robust build process ([e5c6a99][19])

### [2.0.1][20] (2021-06-27)

#### ⚙️ Build system

- Update dependencies and publish fixed apollo example ([ef32668][21])
...
- Add `url` and `paramsPatcher` ([ee31fa8][23])

#### ⚙️ Build system

- **package.json:** update dependencies ([2f1125c][24])
- **package.json:** update dependencies ([7583209][25])
- **package.json:** update next peer dependency to >=10.0.x ([bc5e72d][26])
- Switch to @xunnamius/conventional-changelog-projector shared config
  ([bc7eb3d][27])
- Update dependencies ([20ca255][28])

### [1.2.24][29] (2021-05-08)

#### 🪄 Fixes

- **index.ts:** next 10.2.0 compat ([af177c5][30])

#### ⚙️ Build system

- **.github/workflows:** disable old pipeline; begin transition to new pipeline
  ([364549e][31])
- **.github/workflows:** overhaul pipeline workflows ([4db5d04][32])
...
- **contributing.md:** split pipeline architecture information off into workflow
  README.md ([6d52302][34])
- **package.json:** ensure hidden dirs' markdown files are seen by remark
  (linted and formatted) ([1f7fad4][35])
- **package.json:** update dependencies ([d328a86][36])
- **readme.md:** fix broken links ([6e7173f][37])
- **readme.md:** improvements ([23cb780][38])
- **readme.md:** include architecture description as workflow README.md
  ([1f25e5f][39])

### [1.2.23][40] (2021-03-14)

#### ⚙️ Build system

- Better documentation ([0040582][41])

### [1.2.22][42] (2021-03-12)

#### ⚙️ Build system

- Update dependencies and fix find-package-json usage ([df9ede3][43])

### [1.2.21][44] (2021-03-12)

#### ⚙️ Build system

- **build-test-deploy.yml:** actions version updates ([29aa25a][45])
- **build-test-deploy.yml:** rollback some pipeline version updates
  ([8065757][46])
- **package.json:** fix typedoc-markdown-plugin patch ([dd3e7fa][47])
  <sup>closes [#126][48]</sup>

### [1.2.20][49] (2021-02-22)

#### ⚙️ Build system

- **package-lock.json:** update deps ([5a2d98f][50])

### [1.2.19][51] (2021-02-22)

#### 🪄 Fixes

- **.changelogrc.js:** fix dark magic ([b4157eb][52])
- **is-next-compat.ts:** never use console.log ([81533c8][53])
- **is-next-compat.ts:** use template string instead of literal ([3a4f0f1][54])
- **unit-index.test.ts:** 100% test coverage ([72189e8][55])

#### ⚙️ Build system

- **.eslintrc.js:** account for node 12 ([cad0fb2][56])
- **.github:** update workflows and templates ([54e51eb][57])
- Backport new webpack config ([b268534][58])
- **integration-external.test.ts:** ensure proper cwd is used for executing
  externals ([31c1d5b][59])
- **is-next-compat.ts:** use execa instead of shelljs under the hood
  ([9d12004][60])
- **package.json:** remove shelljs, update other deps ([11e192a][61])
- **package.json:** update dependencies ([9e1705b][62])
- Rename env-expect to expect-env ([035e98b][63])
- **setup.ts:** fix several lib-pkg tools ([44d1967][64])
- Spellcheck-commit and .changelogrc no longer use shelljs ([dd72fd1][65])
- **test:** update with new lib-pkg tools ([004a657][66])
- **unit-external.test.ts:** update with new lib-pkg tools ([6df7e73][67])

#### 🔥 Reverted

- _"debug(build-test-deploy.yml): disable debug mode"_ ([6cefa7a][68])

### [1.2.18][69] (2021-02-11)

#### ⚙️ Build system

- **package.json:** update to proper forked dependencies ([042291d][70])

### [1.2.17][71] (2021-02-10)

#### ⚙️ Build system

- **webpack.config.js:** normalize webpack configuration across repos
  ([65f48a3][72])
- **webpack.config.js:** remove ES6 syntax from JS file ([5ed6dbd][73])

### [1.2.16][74] (2021-02-10)

#### ⚙️ Build system

- **package.json:** update dependencies ([aeef7a9][75])

### [1.2.15][76] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** simplify all examples with more modern syntax; remove
  @ergodark/types ([964bc47][77])

### [1.2.14][78] (2021-02-08)

#### 🪄 Fixes

- **readme.md:** add Apollo example and additional guidance ([ed357f5][79])

### [1.2.13][80] (2021-02-05)

#### 🪄 Fixes

- **config:** use transform-rename-import when building externals
  ([d224f5e][81])
- **index.ts:** use NextApiHandler type (thanks [@janhesters][82])
  ([473ff50][83])
- **integration-webpack.test.ts:** actually call bundle in test ([f7a12de][84])
- **is-next-compat.ts:** better handling of generics ([d7bc091][85])
- Next no longer misclassified as CJS ([9ebac01][86])

#### ⚙️ Build system

- **build-test-deploy.yml:** drop support for node 10 ([6adde15][87])
- **build-test-deploy.yml:** drop support for webpack 4 ([e508c06][88])
- **build-test-deploy.yml:** remove externals exception ([5e3893a][89])
- **cleanup.yml:** fix bugs in workflow ([cbf22fd][90])
- Drop support for node 10 ([71e9103][91])
- Only silence sjx if not DEBUG ([f01ce40][92])
- **package.json:** improved build-dist ([a3526f2][93])
- **package.json:** nicer destructured vals in docs ([661e62d][94])
- **package.json:** remove extraneous module ([1f2ad6a][95])
- **package.json:** update dependencies ([c64f761][96])
- **post-release-check.yml:** add five-minute-sleep ([4a0552d][97])
- **post-release-check.yml:** more resilient post-release check ([856435f][98])
- Properly mocked unit tests for externals ([b3273df][99])
- **test:** improved testing infrastructure ([fffe02e][100])
- **types:** more precise unique-filename type ([a60793c][101])

### [1.2.12][102] (2021-01-23)

#### ⚙️ Build system

- Remove erroneous module import ([6eb2a34][103])

### [1.2.11][104] (2021-01-23)

#### ⚙️ Build system

- Backport/normalize across packages ([e589c1d][105])

### [1.2.10][106] (2021-01-22)

#### ⚙️ Build system

- Update debug statement syntax ([52a2276][107])

### [1.2.9][108] (2021-01-21)
...
### [1.2.8][110] (2021-01-13)

#### 🪄 Fixes

- **readme.md:** ensure quick start example is functional ([87dc31f][111])

### [1.2.7][112] (2021-01-12)

#### ⚙️ Build system

- Rebuild lockfile ([94cfa38][113])
- Update babel-plugin-transform-mjs-imports ([62089c7][114])

### [1.2.6][115] (2021-01-06)

#### ⚙️ Build system

- **package.json:** prune old deps ([2cf1d29][116])

### [1.2.5][117] (2021-01-06)

#### ⚙️ Build system

- **.github/workflows/post-release-check.yml:** add new post-release-check
  ([a307efc][118])
- **.github:** add is-next-compat workflow ([1823c05][119])

### [1.2.4][120] (2021-01-06)

#### ⚙️ Build system

- **readme.md:** add quick start example ([4e5e12c][121])

### [1.2.3][122] (2021-01-05)
...
### [1.2.2][124] (2021-01-05)

#### ⚙️ Build system

- **readme.md:** cosmetic ([98b65c6][125])

### [1.2.1][126] (2021-01-05)
...
- **deps:** bump node-notifier from 8.0.0 to 8.0.1 ([45a79d4][130])
- **test/unit-externals.test.ts:** add mongo uri env var to test explicitly
  ([e0e1fd9][131])

### [1.1.3][132] (2020-12-06)

#### ⚙️ Build system

- **package.json:** audit and update deps ([c82695a][133])
- **package.json:** manually bump version ([813b21a][134])

### [1.1.2][135] (2020-11-26)

#### 🪄 Fixes

- **readme:** update install language ([b68c721][136])

### [1.1.1][137] (2020-11-26)

#### 🪄 Fixes

- **externals:** revert sort-package-json to maintainer version ([750055b][138])
- **externals:** rewrite test workflow ([d604dfc][139])

## [1.1.0][140] (2020-11-25)

#### 🪄 Fixes

- **build:** move Next.js dependency to peer/dev dependencies ([0e7541f][141])
- **externals:** updated remaining dependency references to peerDependency
  references ([ccf54fb][142])

### [1.0.10][143] (2020-10-24)

### [1.0.9][144] (2020-10-23)

### [1.0.8][145] (2020-10-20)

### [1.0.7][146] (2020-10-19)

### [1.0.6][147] (2020-10-17)

### [1.0.5][148] (2020-10-13)

### [1.0.4][149] (2020-10-12)

### [1.0.3][150] (2020-10-12)

### [1.0.2][151] (2020-10-07)

### [1.0.1][152] (2020-10-07)
...
[12]: https://github.com/Xunnamius/next-test-api-route-handler/issues/295
[13]:
...
[16]: https://github.com/Xunnamius/next-test-api-route-handler/issues/296
[17]:
...
[48]: https://github.com/Xunnamius/next-test-api-route-handler/issues/126
[49]:
...
[82]: https://github.com/janhesters
[83]:
...
[153]: https://conventionalcommits.org
